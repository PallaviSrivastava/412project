...
//    /* The action of tagClassChoose will be fired here */
    ...
    $scope.vipsImageSuggest = function(){
        chrome.tabs.executeScript(null,{file: "app/contentScript/vipsImageSuggest.js"});
    };
    $scope.vipsTitleSuggest = function(){
        chrome.tabs.executeScript(null,{file: "app/contentScript/vipsTitleSuggest.js"});
    };
    $scope.vipsLocationSuggest = function(){
        chrome.tabs.executeScript(null,{file: "app/contentScript/vipsLocationSuggestion.js"});
    };
